        ...
        <div class="row">
            <div class="col-lg-12 col-12">
                ...
                <div class="card mb-12">
                    ...
                    <div class="card-body">
                        <div>
                        <form method="POST" id="formvte_fai_framework" enctype="multipart/form-data" action="<?=url("post_banner/save/-1/");?>">                       @csrf
                        @csrf
                            <!-- input -->
                            <div class="row"><div class="col-md-12"><div class="mb-3"><label class="form-label">Banner</label><input name="banner[]" id="banner0" type="file"  class="form-control  banner"  type="text" placeholder="Banner" value="" /></div></div><div class="col-md-12"><div class="mb-3"><label class="form-label">File Tambahan</label><input name="file_tambahan[]" id="file_tambahan0" type="file"  class="form-control  file_tambahan"  type="text" placeholder="File Tambahan" value="" /></div></div><div class="col-md-12"><div class="mb-3"><label class="form-label">Title Banner</label><input name="title_banner" id="title_banner0" type="text"  class="form-control  title_banner"  type="text" placeholder="Title Banner" value="" /></div></div><div class="col-md-12"><div class="mb-3"><label class="form-label">Deskripsi Banner</label><input name="deskripsi_banner" id="deskripsi_banner0" type="text"  class="form-control  deskripsi_banner"  type="text" placeholder="Deskripsi Banner" value="" /></div></div></div></table></div>
