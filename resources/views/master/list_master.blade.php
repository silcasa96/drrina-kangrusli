        ...
        <div class="container-fluid">
            ...
            <div class="flex-grow-1">
                <a class="btn btn-outline-info mb-2 " 
                    href="<?=url('master/tambah/-1/')?>"
                > <span class="fa fa-plus-circle"></span> Master</a>
            </div>    
                                ...
                                <div class="col-md-5">
                                    ...
                                    <form method="POST" id="formimexport_fai_framework" enctype="multipart/form-data" action="<?=url("post_master/list/-1/");?>">
...
@endsection<script>
    ...
    function list_from(Cari) {
        	if(Cari=='pdf'){
        		...
        		window.location.href="<?=url("/master/pdf/-1/");?>";
        	}else if(Cari=='excel'){
        		window.location.href="<?=url("/master/excel/-1/");?>";
        	}else{
