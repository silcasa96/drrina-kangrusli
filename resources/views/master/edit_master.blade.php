@extends('layouts.app2')
        ...
        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">edit_viewsource</li>
                        </ol>
        </div>
    </div>
    <div>
        ...
        <div class="row">
            <div class="col-lg-12 col-12">
                ...
                <div class="card mb-12">
                    ...
                    <div class="card-body">
                        <div>
                        <form method="POST" id="formvte_fai_framework" enctype="multipart/form-data" action="<?=url("post_master/update/$id/");?>">                       @csrf
                        @csrf
                            <!-- input -->
                            ...
                            </button>    <a href="'<?=url("/PDFPage/$id/PDFPage/$id/");?>'"  target="_blank" 
