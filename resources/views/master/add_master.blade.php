        ...
        <div class="row">
            <div class="col-lg-12 col-12">
                ...
                <div class="card mb-12">
                    ...
                    <div class="card-body">
                        <div>
                        <form method="POST" id="formvte_fai_framework" enctype="multipart/form-data" action="<?=url("post_master/save/-1/");?>">                       @csrf
                        @csrf
                            <!-- input -->
                            <div class="row"><div class="col-md-12"><div class="mb-3"><label class="form-label">Logo</label><input name="logo[]" id="logo0" type="file"  class="form-control  logo"  type="text" placeholder="Logo" value="" /></div></div><div class="col-md-12"><div class="mb-3"><label class="form-label">Nama Page</label><input name="nama_page" id="nama_page0" type="text"  class="form-control  nama_page"  type="text" placeholder="Nama Page" value="" /></div></div><div class="col-md-12"><div class="mb-3"><label class="form-label">Deskripsi Page(Seo)</label><input name="deskripsi_page" id="deskripsi_page0" type="text"  class="form-control  deskripsi_page"  type="text" placeholder="Deskripsi Page(Seo)" value="" /></div></div><div class="col-md-12"><div class="mb-3"><label class="form-label">Keyword(Seo)</label><input name="keyword" id="keyword0" type="text"  class="form-control  keyword"  type="text" placeholder="Keyword(Seo)" value="" /></div></div><div class="col-md-12"><div class="mb-3"><label class="form-label">Alamat</label><input name="alamat" id="alamat0" type="text"  class="form-control  alamat"  type="text" placeholder="Alamat" value="" /></div></div><div class="col-md-12"><div class="mb-3"><label class="form-label">No Telpon</label><input name="no_telepon" id="no_telepon0" type="text"  class="form-control  no_telepon"  type="text" placeholder="No Telpon" value="" /></div></div><div class="col-md-12"><div class="mb-3"><label class="form-label">Nama Narahubung</label><input name="nama_narahubung" id="nama_narahubung0" type="text"  class="form-control  nama_narahubung"  type="text" placeholder="Nama Narahubung" value="" /></div></div><div class="col-md-12"><div class="mb-3"><label class="form-label">Email</label><input name="email" id="email0" type="text"  class="form-control  email"  type="text" placeholder="Email" value="" /></div></div></div></table></div>

                                <!-- input -->

                                
                                <div class="modal-footer">
                                <div class=""> <button class="btn btn-outline-info mb-2 " 
                                type="submit"
                             >
                            
										<span class='fa fa-save'></span> Simpan									
                            </button><a href="'<?=url("/list/-1/list/-1/");?>'" class="btn btn-outline-info mb-2  ">
